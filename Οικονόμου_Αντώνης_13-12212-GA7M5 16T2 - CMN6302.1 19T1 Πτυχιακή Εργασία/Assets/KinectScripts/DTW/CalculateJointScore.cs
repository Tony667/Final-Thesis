...
public class CalculateJointScore : MonoBehaviour
{
    public string[] expertMovementContents;
    public string[] expertMovementFields;
    ...
    void Start()
    {
        ...
        //find all text objects and deactivate them
    ...
    private void Update()
    {
        if (compare)
        {
            //find the file, read it, pass the appropriate values to the lists from JointProgression class
            ...
            //caculate the average score for every joint
            calculateJointAverage.CalculateAverage();
            Debug.Log("Average = " + calculateJointAverage.CalculateAverage());

            //create a txt file with the average scores
            ...
            //color text objects red if player performance isn't good enough
            ...
            //pass the score to the text objects with two decimals accuracy
            ...
            //find all text objects and activate them
            foreach (GameObject textField in textFields)
            {
